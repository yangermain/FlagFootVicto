...
export const metadata: Metadata = {
  title: 'Détails de l\'équipe - Ligue de Flag-Football',
  description: 'Statistiques et informations détaillées sur l\'équipe',
};
...
export default async function TeamPage({
  ...
  if (!id || !validTeamIds.includes(id)) {
    notFound();
  }
    ...
    return (
      <div className="py-16">
        <div className="container">
          <div className="mb-8">
            <Link href="/equipes" className="text-primary hover:text-primary-dark">
              ← Retour aux équipes
            </Link>
          </div>
