        ...
        <table className="min-w-full table-auto">
          <thead>
            <tr className="bg-[#1F2937] text-white">
              <th className="cursor-pointer px-4 py-2 text-left border-b border-gray-700" onClick={() => handleSort('team')}>
                Équipe <SortIcon column="team" />
              </th>
              <th className="cursor-pointer px-4 py-2 text-left border-b border-gray-700" onClick={() => handleSort('name')}>
                Nom <SortIcon column="name" />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('number')}>
                No. <SortIcon column="number" />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('position')}>
                Pos. <SortIcon column="position" />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('age')}>
                Âge <SortIcon column="age" />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('experience')}>
                Exp. <SortIcon column="experience" />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('touches', true)}>
                TDs <SortIcon column="touches" isStats={true} />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('attrapes', true)}>
                P.Att <SortIcon column="attrapes" isStats={true} />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('sacks', true)}>
                Sacks <SortIcon column="sacks" isStats={true} />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('interceptions', true)}>
                Int. <SortIcon column="interceptions" isStats={true} />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('penalites', true)}>
                Pén. <SortIcon column="penalites" isStats={true} />
              </th>
              <th className="cursor-pointer px-4 py-2 text-center border-b border-gray-700" onClick={() => handleSort('rabattus', true)}>
          ...
          <tbody className="divide-y divide-gray-100">
            {sortedPlayers.map((player, idx) => (
              <tr key={player.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                ...
                <td className="px-4 py-2 text-center">{player.number}</td>
